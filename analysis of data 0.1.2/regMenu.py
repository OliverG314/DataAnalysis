...
class regMenu(menuWidget):
    ...
    def initWidgets(self):
        ...
        expRegWidget = plotMenuRow(self, [self.expRegCheckBox, expRegLabel])
        ...
        for i in [self.linRegCheckBox, self.polRegCheckBox, self.expRegCheckBox]:
            i.setCheckState([self.parent().showLinReg, self.parent().showPolReg, self.parent().showExpReg][[self.linRegCheckBox, self.polRegCheckBox, self.expRegCheckBox].index(i)])
